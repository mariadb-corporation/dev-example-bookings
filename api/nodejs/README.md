...
The environmental variables from `.env` are used within the [db.js](src/db.js) for the [MariaDB Node.js Connector](https://github.com/mariadb-corporation/mariadb-connector-nodejs) configuration pool settings:
